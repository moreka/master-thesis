...
\begin{figure*}[pt]
    \centering
    \includegraphics[width=.3\textwidth]{figures/mnist-consistency}%
    \includegraphics[width=.3\textwidth]{figures/mnist-extra-regret}\\
    \includegraphics[width=.3\textwidth]{figures/mnist-extra-reg-vs-consistency}%
    \includegraphics[width=.3\textwidth]{figures/mnist-regret}\\
    \includegraphics[width=.3\textwidth]{figures/bwsn-consistency}%
    \includegraphics[width=.3\textwidth]{figures/bwsn-extra-regret}\\
    \includegraphics[width=.3\textwidth]{figures/bwsn-extra-reg-vs-consistency}%
    \includegraphics[width=.3\textwidth]{figures/bwsn-extra-regret-rounded}
    \caption{Top row are experimental results for Online Convex Optimization on MNIST dataset. The bottom row are experimental results for Online Submodular Maximization for the BWSN problem.}
...
\paragraph{Online Convex Optimization} We perform Online Logistic Regression on the MNIST dataset of handwritten digits \cite{lecun1998mnist}, to distinguish digit 3 from 5 over the unit $\ell_1$ ball. In this setting, the expected regret is:
\[
    \mathcal{R}_T = \sum_{t=1}^T f_t(x_t) - T\cdot\min_{\|x\|_1 \leq 1} \EE[f(x)],
\]
where the expectation is with respect to the training set.

\paragraph{Online Submodular Maximization}
